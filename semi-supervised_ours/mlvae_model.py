...
class Net(torch.nn.Module):
    ...
    def supervised_loss(self, data):
        ...
        total_loss = node_kl_divergence_loss + class_kl_divergence_loss + reconstruction_error + 10*cls_loss
    ...
    def unsupervised_loss(self, data):
        ...
        total_loss = 0.00001*(node_kl_divergence_loss + class_kl_divergence_loss + reconstruction_error)
