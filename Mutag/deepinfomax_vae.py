        ...
        for batch_size in batch:
            for num_layer_count in layers:
                for node_dim in node_dims:
                    ...
                    print('current setup seed batch size layers, class dim, node_dim', seed, batch_size, num_layer_count, node_dim, class_dim)
