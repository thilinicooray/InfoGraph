...
def accumulate_edgegroup_evidence(class_mu, class_logvar, batch, edge_idx, is_cuda):
    """
...
def group_wise_reparameterize_edge(training, mu, logvar, labels_batch, edge_index, cuda):
    eps_dict = {}
