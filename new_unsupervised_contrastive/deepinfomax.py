...
class GcnInfomax(nn.Module):
    ...
    def forward(self, x, edge_index, batch, num_graphs):
        ...
        return  reconstruction_error.item(), class_kl_divergence_loss.item() , node_kl_divergence_loss.item(), local_global_loss.item()
    ...
    for seed in [52]:
        ...
        for epoch in range(1, epochs+1):
            ...
            for data in dataloader:
                ...
                optimizer.zero_grad()
                recon_loss, kl_class, kl_node, mi_loss = model(data.x, data.edge_index, data.batch, data.num_graphs)
