    ...
    def get_embeddings(self, loader):
        ...
        with torch.no_grad():
            for data in loader:
                ...
                node_mu, node_logvar, class_mu, class_logvar, entangledrep = self.encoder(x[:,:29], edge_index, batch)
                ...
                node_label_idx = (data.x[:,29:] != 0).nonzero()[:,1]
    ...
    for seed in [52]:
        ...
        for epoch in range(1, epochs+1):
            ...
            for data in dataloader:
                ...
                current_loss = model(data.x[:,:29], data.edge_index, data.batch, data.num_graphs)
