...
class GcnInfomax(nn.Module):
    ...
    def forward(self, x, edge_index):
        ...
        loss =  class_kl_divergence_loss + 100*node_kl_divergence_loss + 100*reconstruction_error

        loss.backward()


        return  reconstruction_error.item(), 100*class_kl_divergence_loss.item() , 100*node_kl_divergence_loss.item()
...
if __name__ == '__main__':
    ...
    for seed in [123]:
        ...
        for coef in range(runs+1):
            ...
            train_emb, train_y_labels, val_emb, val_y_labels,test_emb, test_y_labels  = model.get_embeddings(data, lamda)
        ...
        savetxt('gate_acc_citeseer_s1.csv', overall_acc, delimiter=',')
        savetxt('gate_val_citeseer_s1.csv', lambdas, delimiter=',')
