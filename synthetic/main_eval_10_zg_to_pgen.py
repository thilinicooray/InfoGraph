...
class GLDisen(nn.Module):
    ...
    def get_embeddings(self, loader):
        ...
        prob = [ 0.4,0.533,0.711, 0.267, 0.1111111111111111]
        labels = [0,1,2,3,4,5,6]
        zg = torch.tensor([-1.21,-1.27,-1.29,-1.14, 0.8799999952316285 ]).to(device)
        ...
        savetxt('global_rep_change_my_10_correct.csv',global_rep, delimiter=',')
        savetxt('regen_p_change_my_10_correct.csv', regen, delimiter=',')
