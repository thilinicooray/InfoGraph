    ...
    def get_embeddings(self, loader):
        ...
        with torch.no_grad():
            for data in loader:
                ...
                print('node', node_latent_embeddings_org)

                print('graph', data.y, indiclass_latent_embeddings_org)
                ...
                reconstructed_node = self.decoder(node_latent_embeddings_org, accumulated_class_latent_embeddings)
