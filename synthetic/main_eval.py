...
class GLDisen(nn.Module):
    ...
    def get_embeddings(self, loader):
        ...
        savetxt('global_rep_nodewise.csv', global_rep, delimiter=',')
        savetxt('local1_nodewise.csv', local1, delimiter=',')
        savetxt('local2_nodewise.csv', local2, delimiter=',')
        savetxt('probability_nodewise.csv', probability, delimiter=',')
