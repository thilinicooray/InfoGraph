...
class GLDisen(nn.Module):
    ...
    def get_embeddings(self, loader):
        ...
        savetxt('global_rep_tot_50_regen1_small_correct.csv', global_rep, delimiter=',')
        savetxt('regen_p1_small_correct.csv', regen, delimiter=',')
        savetxt('org_p1_small_correct.csv', org, delimiter=',')
