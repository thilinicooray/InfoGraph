    ...
    def get_embeddings(self, loader):
        ...
        with torch.no_grad():
            for data in loader:
                ...
                mu, logvar, entangledrep = self.encoder(x[:,:4].double(), edge_index, batch)
    ...
    for seed in [52]:
        ...
        for epoch in range(1, epochs+1):
            ...
            for data in dataloader:
                ...
                optimizer.zero_grad()
                recon_loss, kl_class, kl_node = model(data.x[:,:4].double(), data.edge_index, data.batch, data.num_graphs)
