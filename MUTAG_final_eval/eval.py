    ...
    def get_embeddings(self, loader):
        ...
        with torch.no_grad():
            for data in loader:
                ...
                sim_node = torch.tanh(torch.matmul(entangled.t(), node_latent_embeddings)).cpu().numpy()
                graph_node = torch.tanh(torch.matmul(entangled.t(), accumulated_class_latent_embeddings)).cpu().numpy()
