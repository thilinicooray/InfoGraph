...
class GcnInfomax(nn.Module):
    ...
    def forward(self, x, edge_index, batch, num_graphs):
        ...
        node_kl_divergence_loss = 0.00000001 * node_kl_divergence_loss
        ...
        class_kl_divergence_loss = 0.00000001 * class_kl_divergence_loss
    ...
    for seed in seeds:
        for epochs in epochs_list:
            for rat in node_ratio:
                ...
                torch.save(model.state_dict(), f'best_best_model_128_new.pkl')
