...
class GLDisen(nn.Module):
    def __init__(self, hidden_dim, num_gc_layers, node_dim, class_dim):
        ...
        self.slot_attention = SlotAttention(3, class_dim)
        self.attention = Attention(class_dim, class_dim, class_dim)
        ...
        for epochs in epochs_list:
            for rat in node_ratio:
                ...
                for epoch in range(1, epochs+1):
                    ...
                    '''clskl_current = kl_class_loss_all/ len(dataloader)
