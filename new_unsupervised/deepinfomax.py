...
class GcnInfomax(nn.Module):
  ...
  def forward(self, x, edge_index, batch, num_graphs):
    ...
    node_kl_divergence_loss = 0.00000001*node_kl_divergence_loss *num_graphs
    ...
    class_kl_divergence_loss = 0.000000001* class_kl_divergence_loss * num_graphs
    ...
    reconstruction_error = 0.001* self.recon_loss(reconstructed_node, edge_index, batch) * num_graphs
